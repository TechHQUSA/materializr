...
void HelpPanel::render() {
    ...
    ImGui::TextWrapped(
        materializr::tr("Welcome to Materializr — a parametric 3D CAD app. This guide covers the basics so you can get something on screen quickly. Camera controls and key bindings can be changed in File → Settings."));
    ...
    ImGui::Separator();
    ImGui::TextDisabled(
        materializr::tr("Tip: press Esc to cancel any in-progress operation. Ctrl+Z / Ctrl+Y undo and redo history steps."));
