...
| CONVERTED | src/app/PushPullController.cpp:725 | `if (materializr::amountLengthField("ppAmt", m_st.symmetric ? "Per side" : "Distance", &m_st.distance, /*allowS` |
| CONVERTED | src/app/PushPullController.cpp:739 | `(void)materializr::parseLength(m_st.inputBuf, m_st.distance);` |
| CONVERTED | src/app/PushPullController.cpp:746 | `if (materializr::parseLength(m_st.inputBuf, parsed) &&` |
| CONVERTED | src/app/PushPullController.cpp:762 | `materializr::lengthStepperRow("ppStep", &m_st.distance,` |
| CONVERTED | src/app/PushPullController.cpp:808 | `(void)materializr::parseLength(m_st.inputBuf, m_st.distance);` |
...
| diagnostic | src/app/PushPullController.cpp:582 | `std::fprintf(stdout, "Push/Pull committed at %.2f mm\n", m_st.distance);` |
| diagnostic | src/app/PushPullController.cpp:593 | `std::fprintf(stdout, "Push/Pull committed at %.2f mm\n", m_st.distance);` |
| diagnostic | src/app/PushPullController.cpp:605 | `std::fprintf(stdout, "Push/Pull (smart cut) committed at %.2f mm\n",` |
| diagnostic | src/app/PushPullController.cpp:612 | `std::fprintf(stdout, "Push/Pull committed at %.2f mm\n", m_st.distance);` |
