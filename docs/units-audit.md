...
| dim | file:line | code |
|---|---|---|
| seconds | src/app/Application_Dialogs.cpp:316 | `if (ImGui::SliderFloat(materializr::tr("Fillet time limit"),` |
| px/ui | src/app/Application_Dialogs.cpp:335 | `if (ImGui::SliderFloat(materializr::tr("Selection line width"), &m_selectionLineWidth, 1.0f, 10.0f, "%.1f px")` |
| px/ui | src/app/Application_Dialogs.cpp:346 | `if (ImGui::SliderFloat(materializr::tr("Sketch line width"), &m_sketchLineWidth, 1.0f, 6.0f, "%.1f px")) {` |
| percent | src/app/Application_Dialogs.cpp:353 | `if (ImGui::SliderFloat(materializr::tr("Grid opacity"), &m_sketchGridOpacity,` |
| px/ui | src/app/Application_Dialogs.cpp:358 | `if (ImGui::SliderFloat(materializr::tr("Grid thickness"), &m_sketchGridThickness,` |
| seconds | src/app/Application_Dialogs.cpp:464 | `if (ImGui::SliderFloat(materializr::tr("Double-click speed"), &m_doubleClickTime,` |
| px/ui | src/app/Application_Dialogs.cpp:481 | `if (ImGui::SliderFloat(materializr::tr("Mouse sensitivity"), &sens,` |
| ratio | src/app/Application_Dialogs.cpp:513 | `if (ImGui::SliderFloat(materializr::tr("Orbit##touchSens"), &m_touchOrbitSens, 0.25f, 3.0f, "%.2fx")) changed ` |
| ratio | src/app/Application_Dialogs.cpp:514 | `if (ImGui::SliderFloat(materializr::tr("Pan##touchSens"),   &m_touchPanSens,   0.25f, 3.0f, "%.2fx")) changed ` |
| ratio | src/app/Application_Dialogs.cpp:515 | `if (ImGui::SliderFloat(materializr::tr("Zoom##touchSens"),  &m_touchZoomSens,  0.25f, 3.0f, "%.2fx")) changed ` |
| ratio | src/app/Application_Dialogs.cpp:534 | `if (ImGui::SliderFloat(materializr::tr("Ambient"), &m_lightAmbient, 0.0f, 1.0f, "%.2f")) {` |
| ratio | src/app/Application_Dialogs.cpp:585 | `if (ImGui::SliderFloat(materializr::tr("Default STL accuracy"), &m_stlImportAccuracy,` |
| angle | src/app/Application_Dialogs.cpp:792 | `ImGui::SliderFloat("##slider", &m_multiRotate[i], -180.0f, 180.0f, "%.1f°");` |
| angle | src/app/Application_Dialogs.cpp:795 | `materializr::inputNumber("##input", &m_multiRotate[i], 0.0f, 0.0f, "%.3f");` |
...
| CONVERTED | src/app/Application_Dialogs.cpp:4640 | `if (materializr::lengthSlider(materializr::trFormat("Height (%s)", materializr::unitSuffix()).c_str(), &h, 1.0` |
| CONVERTED | src/app/Application_Dialogs.cpp:4744 | `if (materializr::lengthSlider(materializr::trFormat("Chord (%s)", materializr::unitSuffix()).c_str(), &chord, ` |
| seconds | src/app/Application_Dialogs.cpp:4755 | `if (ImGui::SliderInt(materializr::tr("Points per surface"), &budget, 8, 200) &&` |
| CONVERTED | src/app/Application_Dialogs.cpp:4868 | `if (materializr::lengthSlider(materializr::trFormat("Width (%s)", materializr::unitSuffix()).c_str(), &w, 1.0f` |
| CONVERTED | src/app/Application_Dialogs.cpp:5038 | `if (materializr::lengthField("##offsetDist", &mag,` |
| CONVERTED | src/app/Application_Dialogs.cpp:5110 | `materializr::amountLengthField(label, label, v);` |
| CONVERTED | src/app/Application_Dialogs.cpp:5112 | `materializr::lengthField(label, v);` |
| CONVERTED | src/app/Application_Dialogs.cpp:5141 | `materializr::lengthField("X", &m_primitivePopupOrigin[0]);` |
| CONVERTED | src/app/Application_Dialogs.cpp:5142 | `materializr::lengthField("Y", &m_primitivePopupOrigin[1]);` |
| CONVERTED | src/app/Application_Dialogs.cpp:5143 | `materializr::lengthField("Z", &m_primitivePopupOrigin[2]);` |
| ratio | src/app/Application_Dialogs.cpp:5313 | `ImGui::SliderFloat(materializr::tr("Accuracy"), &m_stlDialogAccuracy, 0.0f, 1.0f, "%.2f");` |
| CONVERTED | src/app/Application_Dialogs.cpp:5817 | `if (materializr::lengthField(materializr::trFormat("Thickness (%s)", materializr::unitSuffix()).c_str(), &m_un` |
| angle | src/app/Application_Dialogs.cpp:5831 | `if (ImGui::SliderFloat(materializr::tr("Curve detail"), &m_unfoldMaxBevelDeg, 2.0f, 40.0f, "%.0f°"))` |
| angle | src/app/Application_Dialogs.cpp:5890 | `ImGui::SliderFloat(materializr::tr("Rotate"), &m_unfoldRotationDeg, -180.0f, 180.0f, "%.0f°");` |
| CONVERTED | src/app/Application_Viewport.cpp:2073 | `(void)materializr::parseFinite(m_sketchShapeDimBuf,` |
| CONVERTED | src/app/Application_Viewport.cpp:2075 | `if (touchui::numberField("##bubbleDia", nullptr,` |
| CONVERTED | src/app/Application_Viewport.cpp:2096 | `materializr::lengthField("##bubbleW", &m_sketchShapeDimW);` |
| CONVERTED | src/app/Application_Viewport.cpp:2099 | `materializr::lengthField("##bubbleH", &m_sketchShapeDimH);` |
| CONVERTED | src/app/Application_Viewport.cpp:2119 | `if (!materializr::parseLength(m_sketchShapeDimBuf, mm) \|\| mm <= 0.0) return false;` |
| CONVERTED | src/app/Application_Viewport.cpp:3242 | `(void)materializr::parseFinite(m_dimEditingBuf, dimPadV);` |
| CONVERTED | src/app/Application_Viewport.cpp:3247 | `if (materializr::inputNumber("##dimval", &dimPadV, 0.0, 0.0, padFmt,` |
| angle | src/app/Application_Viewport.cpp:6009 | `(void)materializr::parseFinite(m_sketchGizmoRotateBuf,` |
| angle | src/app/Application_Viewport.cpp:6011 | `bool typedEnter = materializr::inputNumber(` |
| angle | src/app/Application_Viewport.cpp:6024 | `(void)materializr::parseFinite(m_sketchGizmoRotateBuf, deg);` |
| angle | src/app/Application_Viewport.cpp:6041 | `(void)materializr::parseFinite(m_sketchGizmoRotateBuf, deg);` |
| CONVERTED | src/app/Application_Viewport.cpp:7342 | `materializr::lengthField("##dimW", &m_sketchShapeDimW);` |
| CONVERTED | src/app/Application_Viewport.cpp:7345 | `materializr::lengthField("##dimH", &m_sketchShapeDimH);` |
| CONVERTED | src/app/Application_Viewport.cpp:7381 | `const bool entered = materializr::inputNumber(` |
| CONVERTED | src/app/Application_Viewport.cpp:7399 | `return dimIsLen ? materializr::lengthFieldCommit(shown) : shown;` |
| CONVERTED | src/app/Application_Viewport.cpp:7434 | `const bool ok = isLen ? materializr::parseLength(m_sketchDimBuf, v0)` |
| angle | src/app/Application_Viewport.cpp:7435 | `: materializr::parseFinite(m_sketchDimBuf, v0);` |
...
|---|---|---|
| comment | src/app/Application.cpp:919 | `// ios_platform.mm).` |
| comment | src/app/Application.cpp:1177 | `// Create a demo box so there's something to see (a 20 mm cube) - but only` |
| comment | src/app/Application.cpp:1962 | `// Absolute linear deflection (mm) and angular deflection (radians). Lower` |
| comment | src/app/Application.cpp:2035 | `// or, from before the presets converted, wrote 1 and reloaded as a 1 mm` |
...
| comment | src/app/Application.cpp:4795 | `// step is the snap lattice and the visible grid, so leaving it at 1 mm` |
| comment | src/app/Application.cpp:4803 | `// 152 mm - see 0733a59, which reverted exactly that.` |
| comment | src/app/Application.cpp:5576 | `// the surface's parametric origin ~0.3 mm off-axis - the fitted anchor` |
| comment | src/app/Application.cpp:5638 | `// 0.64 mm off-axis). Fit a circle to the OUTER wire instead, then` |
| comment | src/app/Application.cpp:5703 | `// then keeps the wrong band, landing 0.6 mm off with a` |
| comment | src/app/Application.cpp:5752 | `// 0.64 mm off-axis at the surface origin) that WON` |
| comment | src/app/Application.cpp:5846 | `// sides at a generous offset (1 mm) so tessellation slack near the` |
| comment | src/app/Application.cpp:5861 | `const double eps = 1.0; // mm` |
| comment | src/app/Application.cpp:6489 | `// lines wrote raw millimetres: placing a dimension under any non-mm unit` |
| comment | src/app/Application.cpp:6524 | `// Hash point positions and circle/arc radii too (quantised to 1e-4 mm)` |
| comment | src/app/Application.cpp:6863 | `// millimetres. 40 mm is a reasonable first view in millimetres and an` |
| comment | src/app/Application.cpp:6923 | `// Measured offsets were 10–50% of a cell. At a 1 mm grid that reads as` |
| comment | src/app/Application.cpp:6924 | `// slightly-fat lines; at 0.1 mm it is most of a cell, i.e. "I can't draw a` |
...
| comment | src/app/Application_Dialogs.cpp:4644 | `// dimension, and a text height that came out 1 mm or 100 mm` |
| comment | src/app/Application_Dialogs.cpp:4810 | `// Real extents of the section, anchor-relative and in mm, so the` |
| comment | src/app/Application_Dialogs.cpp:5360 | `// Write a 1:1-mm SVG. cut = solid black (the outline). For SemiRigid the fold` |
| comment | src/app/Application_Dialogs.cpp:5465 | `double minx = 0, miny = 0, maxx = 0, maxy = 0;   // pattern bbox (mm)` |
| comment | src/app/Application_Dialogs.cpp:5467 | `double pad = 5, margin = 12, strip = 12, overlap = 12;  // mm` |
| comment | src/app/Application_Dialogs.cpp:5468 | `double cwMM = 0, chMM = 0, stepX = 0, stepY = 0; // tile content + step (mm)` |
| comment | src/app/Application_Dialogs.cpp:5497 | `// An alignment cross at a position (in drawing-mm) that falls inside a tile` |
| comment | src/app/Application_Dialogs.cpp:5502 | `// filler marks between the seams so you can pick the density. The same drawing-mm` |
| allowed-by-hand | src/app/Application_Dialogs.cpp:5540 | `// corners, an overlap between tiles for assembly, and a 50 mm scale bar in the` |
| comment | src/app/Application_Dialogs.cpp:5552 | `auto DX = [&](double x) { return (x - minx) + pad; };   // world → drawing mm (Y up)` |
| comment | src/app/Application_Dialogs.cpp:5562 | `const double ox = col * stepX, oy = row * stepY;    // tile origin (drawing mm)` |
| comment | src/app/Application_Dialogs.cpp:5609 | `// Registration crosses in the tile OVERLAPS: the same drawing-mm point` |
| comment | src/app/Application_Dialogs.cpp:5614 | `const double regArm = 4.0;                    // mm half-length of each arm` |
| comment | src/app/Application_Dialogs.cpp:5636 | `// 50 mm scale bar in the bottom strip + caption + tile label.` |
| allowed-by-hand | src/app/Application_Dialogs.cpp:5641 | `pdff(s, "BT /F1 8 Tf %.2f %.2f Td (50 mm \\(5 cm\\) - verify print scale) Tj ET\n",` |
| allowed-by-hand | src/app/Application_Dialogs.cpp:6069 | `: "Tiled, full-size (1:1) PDF with crop marks, a 50 mm scale bar, and "` |
...
| comment | src/app/Application_Viewport.cpp:1657 | `// Push/pull STARTS at 0 mm (no change), and drawDim draws` |
| comment | src/app/Application_Viewport.cpp:1776 | `// the analogue of the mm readout for moves. Uses the cached pivot` |
| comment | src/app/Application_Viewport.cpp:1842 | `// format hid everything under 0.1 mm. (No <cstring> needed -` |
| comment | src/app/Application_Viewport.cpp:1844 | `auto fmtLen = [](char* out, size_t n, float v) {   // v is mm; prints display unit` |
| identifier/other | src/app/Application_Viewport.cpp:2118 | `double mm = 0.0;   // "2in" honoured; bare = display unit` |
| identifier/other | src/app/Application_Viewport.cpp:2119 | `if (!materializr::parseLength(m_sketchShapeDimBuf, mm) \|\| mm <= 0.0) return false;` |
| identifier/other | src/app/Application_Viewport.cpp:2120 | `v = static_cast<float>(mm);` |
| comment | src/app/Application_Viewport.cpp:2621 | `// Cursor in sketch mm - the space labelOffX/Y lives in, so a` |
| comment | src/app/Application_Viewport.cpp:3269 | `// Convert to mm FIRST, then halve a circle's` |
| comment | src/app/Application_Viewport.cpp:4793 | `// 0.5 mm + 0.5 % of view distance instead; an actually-` |
| comment | src/app/Application_Viewport.cpp:4794 | `// occluding face is normally many mm in front.` |
| comment | src/app/Application_Viewport.cpp:5252 | `// ~ 0.85 mm at 240 dpi is unhittable). Still clamped` |
| comment | src/app/Application_Viewport.cpp:5694 | `// 0.5 mm line nudge → 1 mm mirror shift on a 1 mm grid).` |
| comment | src/app/Application_Viewport.cpp:6220 | `// user lands within 0.4 mm of the previous click -` |
| comment | src/app/Application_Viewport.cpp:7396 | `// The pad edits in the display unit; the floor is mm.` |
| comment | src/app/Application_Viewport.cpp:7430 | `// Converting those display->mm made a typed 180 deg arrive` |
...
| comment | src/io/Settings.cpp:184 | `// millimetres, where a deliberate 0.05 mm grid is a real choice` |
| comment | src/io/Settings.h:169 | `// Snap-to-grid toggle and step (mm) shared by the sketch grid and the` |
| comment | src/io/Settings.h:171 | `// have to re-enable snap and re-pick a 1 mm step every launch.` |
| comment | src/io/Settings.h:179 | `// to mm on load, after the display unit is applied.` |
| comment | src/io/Settings.h:204 | `// (0 mm, 1 cm, 2 m, 3 in, 4 ft). An int for the same reason language is -` |
| comment | src/io/Settings.h:205 | `// this header stays free of core/Units.h. The model is always mm; this only` |
...
| comment | src/modeling/SketchTool.cpp:492 | `// Popup asks for DIAMETER (matching the on-canvas "X.X mm dia"` |
| comment | src/modeling/SketchTool.cpp:688 | `// comes out NEARLY axis-aligned, "nearly" is the bug: 1° over 80 mm is` |
| comment | src/modeling/SketchTool.cpp:715 | `// 4° rule. (Steve: a 1 mm rise over a long run must not snap to horizontal.)` |
| comment | src/modeling/SketchTool.cpp:919 | `// neighbouring grid intersection. The old absolute 0.25 mm floor meant a` |
| comment | src/modeling/SketchTool.cpp:920 | `// fine grid was swamped by it: at a 0.1 mm grid a second point placed one` |
| comment | src/modeling/SketchTool.cpp:921 | `// or two steps (0.1–0.2 mm) from the first snapped straight back onto it -` |
| comment | src/modeling/SketchTool.cpp:922 | `// so nothing shorter than ~0.3 mm could be drawn, and an endpoint snap` |
| comment | src/modeling/SketchTool.cpp:923 | `// hijacked the cursor within 0.3 mm of any point (Steve's report). Coarse` |
| comment | src/modeling/SketchTool.cpp:925 | `// ~0.42 mm). Grid OFF: the cursor is freehand, so keep an absolute band to` |
| comment | src/modeling/SketchTool.cpp:978 | `// 0.25 mm even with snap off), which is why Steve couldn't make a line` |
| comment | src/modeling/SketchTool.cpp:979 | `// under ~0.25 mm with grid AND inferences both off. Loop closure welds` |
| comment | src/modeling/SketchTool.cpp:1346 | `// snap above: with grid snap on, an absolute 0.2 mm floor would fire a` |
| comment | src/modeling/SketchTool.cpp:1347 | `// horizontal/vertical guide off a point within 0.2 mm on a fine grid,` |
| comment | src/modeling/SketchTool.cpp:1354 | `// shrinks to sub-pixel at low zoom (e.g. on an 80 mm part viewed whole),` |
| comment | src/modeling/SketchTool.cpp:1367 | `// at 100 mm = 5 mm of cursor theft). An inference may only pull the` |
| comment | src/modeling/SketchTool.cpp:1370 | `// absolute 1.5 mm floor let a directional guide yank the cursor ~1.5 mm -` |
| comment | src/modeling/SketchTool.cpp:1371 | `// 15 increments at a 0.1 mm grid - so once the (now tight) endpoint band` |
| comment | src/modeling/SketchTool.cpp:1373 | `// ~1.3 mm out. Tie the pull to the grid so it can't reach past ~1.5` |
| comment | src/modeling/SketchTool.cpp:1802 | `// angular window up: at a 1 mm grid it means 5.7 deg of catch` |
| comment | src/modeling/SketchTool.cpp:1803 | `// on a 3 mm leg and worse below that, which is exactly the` |
| comment | src/modeling/SketchTool.cpp:1978 | `// x=9.0033 on a 0.1 mm grid, a guide pair at y=12.2012. Over a few` |
| comment | src/modeling/SketchTool.cpp:2000 | `// a 1 mm grid: 8.4 deg on a 3 mm leg off a 70 deg corner, 3.4 deg at` |
| comment | src/modeling/SketchTool.cpp:2001 | `// 5 mm, decaying as 1/length). The guide still highlights, because it` |
| comment | src/modeling/SketchTool.cpp:2016 | `// charged vertical, that can be a few mm off the cursor's perpendicular` |
| comment | src/modeling/SketchTool.cpp:2017 | `// path. With posCap (1.5 mm) we'd silently fall through to single-line` |
| comment | src/modeling/SketchTool.cpp:2019 | `// which is what Steve hit in the 18.9 mm screenshot.` |
| comment | src/modeling/SketchTool.cpp:2024 | `// does is relative to the segment being drawn - 1.5 mm off a 100 mm line` |
| comment | src/modeling/SketchTool.cpp:2025 | `// is nothing, 1.5 mm off a 2 mm line is the line. That asymmetry is why` |
| comment | src/modeling/SketchTool.cpp:2027 | `// near the anchor (Steve, 2026-09-03: a 2 mm line placed fine, 1 mm and` |
| comment | src/modeling/SketchTool.cpp:2028 | `// 3 mm were unreachable, the only alternatives being no line at all - an` |
| comment | src/modeling/SketchTool.cpp:2030 | `// 19 mm jump to a farther intersection still inside the 5x pair cap).` |
| comment | src/modeling/SketchTool.cpp:2033 | `// out of the way: past ~6 mm of draw the absolute caps bind again, so` |
| comment | src/modeling/SketchTool.cpp:2173 | `// (Steve.) Grid off keeps the original mm-based cap.` |
| comment | src/modeling/SketchTool.cpp:2212 | `// when they explicitly asked for 1 mm precision. The toolbar "Snap to` |
| comment | src/modeling/SketchTool.cpp:2222 | `// declaration for why. 0.3 mm is the radius every caller here used before the` |
| comment | src/modeling/SketchTool.cpp:2241 | `// A weld radius is a SCREEN distance. As a fixed 0.3 mm it shrank with the` |
| comment | src/modeling/SketchTool.cpp:2246 | `// welded. Change the lattice underfoot and it stops - switching feet -> mm` |
| comment | src/modeling/SketchTool.cpp:2248 | `// (304.8-based vs 1-based), the closing click snaps elsewhere, and 0.3 mm` |
| comment | src/modeling/SketchTool.cpp:2251 | `// Same shape as tolStep()'s screen term, and the 0.3 mm stays as a floor so` |
| comment | src/modeling/SketchTool.cpp:2440 | `// It used to be a hand-rolled scan at 1e-4 mm, which is exact equality` |
| comment | src/modeling/SketchTool.cpp:2447 | `// sketch to extrude" after switching feet -> mm, then as "I can't close` |
